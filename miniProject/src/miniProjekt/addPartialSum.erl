...
makeNumber($A, Base) when Base > 10 ->
				10;
makeNumber(15, Base) when Base > 15 ->
				15;
makeNumber(14, Base) when Base > 14 ->
				14;
makeNumber(13, Base) when Base > 13 ->
				13;
makeNumber(12, Base) when Base > 12 ->
				12;
makeNumber(11, Base) when Base > 11 ->
				11;
makeNumber(10, Base) when Base > 10 ->
				10;
